        ...
        <v-list-item-avatar v-if="!gender">
         ...
         <v-list-item-avatar v-if="gender">
          ...
          <v-list-item-content>
            ...
            <v-list-item-subtitle class="font">User</v-list-item-subtitle>
          </v-list-item-content>
        </v-list-item>

            <v-divider></v-divider>
          
          <v-list-item class="font" link exact :to="{ name: 'Home' }">
              <v-list-item-action>
          ...
          <v-list-item class="font" link exact :to="{ name: 'Profile' }">
              <v-list-item-action>
...
<!-- <<<<<<< HEAD
          ...
          <v-list-item class="font" link exact :to="{ name: 'SpaAboutUs' }">
